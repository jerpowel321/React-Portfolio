...
<button className="navbar-toggler " type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div className="navbar-collapse navbar-collapse2 collapse w-100 order-3 dual-collapse2">
        <ul className="navbar-nav ml-auto">
			...
			<li className="nav-item">
                <a className="nav-link" href="https://www.dropbox.com/s/p4cxz05omtwpikc/JenniferPowell_Resume.pdf?dl=0" target="blank"><i className="fas fa-file-pdf fa-2x ml hvr-grow nml"></i></a>
            </li>
