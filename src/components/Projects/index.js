...
const projects = [
	...
	{ project: 'Bamazon', Img: 'https://media.giphy.com/media/mxSYpbCWQFQAMh9oOU/giphy.gif', Description: 'Bamazon is an e-commerce storefront where customers can buy magical items such as Obiedient Wands and managers can restock inventory.', Technologies: 'javaScript, jQuery, mySql, Node.js' },
					...
					{projects.map((a, i) =>
						<div className="project" style={{ border: '5px solid colors[i]' }}>
							...
							<p className="text-center pt-3">
								<p><a key={i} href={a.GitHub} target="_blank"><i className="fab fa-github fa-2x icon"></i></a>
									<a key={i} href={a.Deployed} target="_blank"><i className="fas fa-rocket fa-2x ml-2 icon"></i></a></p>
